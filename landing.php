...
<html lang="fr">
  ...
  <div class="text-center">
    ...
    <ul class="nav justify-content-center navbar">
        <li class="nav-item">
          <a class="nav-link text-white" aria-current="page" href="accueilconnecter.html">Accueil</a>
        </li>
        <li class="nav-item">
    ...
    <div class="text-center">
        <h1 class="p-5">Bienvenue <?php echo $data['pseudo']; ?> !</h1>
    </div>
    ...
    <div class="table-product">
        <table>
            <tr>
                ...
                <th class="res"scope="col">Rendre livre</th>
            </tr>
            <tbody>
                <?php
                $idpro = 1;
                while ($row = mysqli_fetch_array($query)) { ?>
                    <tr>
                        ...
                        <td class="delete"><a name="id" id="" class="bdelete" href="main/rendre.php?id=<?php echo $row['id'] ?>" role="button">
                               Rendre
                            </a></td>
                    </tr>
                <?php
