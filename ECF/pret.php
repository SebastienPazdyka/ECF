...
<div class="text-center">
    ...
    <ul class="nav justify-content-center navbar">
        ...
        <li class="nav-item">
          <a class="nav-link text-white" href="catalogueconnecter.php.php">Catalogue</a>
        </li>
      </ul>
    </div>
    ...
    <div class="table-product">
        <table class="table">
            <thead class="thead-dark">
                ...
                <th scope="col">Nombres restant</th>
               </tr>
            </thead>
            <tbody>
                <?php
    ...
    <div class="addproduct">
            <form method="POST" action="main/pret.php">
                ...
                <div class="form-button">
                    <button type="submit" class="modify" style="float:right">Emprunter</button>
                    <a name="" id="" class="return" href="catalogueconnecter.php" role="button" style="float:left">Retour</a>
                </div>
            </form>
        </div>
    </div>
